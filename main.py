...
class MainWidget(RelativeLayout):
    ...
    ship = None
    SHIP_WIDTH = .05
    SHIP_HEIGHT = (((3**(1/2)) * SHIP_WIDTH)/2)
    SHIP_BASE_Y = 0.04
    ...
    def init_audio(self):
        ...
        self.sound_gameover_voice = SoundLoader.load('audio/main1_game_end.wav')
        self.sound_music1 = SoundLoader.load('audio/main1_game_play.wav')
        ...
        self.sound_gameover_impact.volume = .15
